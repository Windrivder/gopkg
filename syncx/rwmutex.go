...
// NewRWMutex creates and returns a new *RWMutex.
...
func NewRWMutex(safe ...bool) *RWMutex {
	mu := CreateRWMutex(safe...)
	return mu
}

// CreateRWMutex creates and returns a new RWMutex object.
// The parameter <safe> is used to specify whether using this mutex in concurrent safety,
// which is false in default.
func CreateRWMutex(safe ...bool) *RWMutex {
	mu := &RWMutex{}
